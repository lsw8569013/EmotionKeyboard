package com.example.sunxiaodong.emotionkeyboard.filter;

import android.text.Spannable;
import android.widget.EditText;

import com.example.sunxiaodong.library.utils.EmotionKeyboardUtils;
import com.example.sunxiaodong.library.widget.EmotionFilter;
...
/**
 * Created by sunxiaodong on 16/4/18.
 */
public class EmojiFilter extends EmotionFilter {
    ...
    public void filter(EditText editText, CharSequence text, int start, int lengthBefore, int lengthAfter) {
        emojiSize = emojiSize == -1 ? EmotionKeyboardUtils.getFontHeight(editText) : emojiSize;
